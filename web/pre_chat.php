...
<script>
  ...
  var ref = firebase.database().ref('test/').once('value').then(function(snapshot) {
    ...
    if(array.length > 0) {
      ...
      var string = '<a href="javascript:postwith(\'chat.html\',{email1:\''+firebase.auth().currentUser.email+'\',email2:\'mhishidestinys@gmail.com\'})">click</a>';
      ...
      for(var i = 2; i < array.length; i++) {
        string += '<a href=\"javascript:postwith(\"chat.html\", {email:\'+ firebase.auth().currentUser.email + \', email2:\'+ array[i] + \'})\">' + array[i] + "</a><br>";
        console.log(string);
